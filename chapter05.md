...
در این فصل دیدیم شل هنگام روبه‌رو شدن با یک نام چه انتخاب‌هایی دارد و چطور می‌توانیم با `type`، `which`، `help`، `man` و سایر مستندات، ماهیت هر دستور را به دقت تشخیص دهیم.
همچنین با استفاده از `alias` و قابلیت‌های تاریخچه آموختیم چطور انجام کارهای تکراری را سرعت بدهیم و فرمان‌های قدیمی را بدون تایپ دوباره بازیابی کنیم.
در فصل بعد با **تغییر مسیر ورودی و خروجی (I/O Redirection)** آشنا خواهیم شد؛ قابلیتی که پایهٔ بسیاری از زنجیره‌های پردازش قدرتمند در خط فرمان است.
