...
تغییر مسیر ورودی و خروجی یکی از مهم‌ترین مهارت‌های کار با خط فرمان است. با دانستن نحوه‌ی هدایت جریان‌های استاندارد می‌توانیم دستورات ساده را به زنجیره‌های قدرتمند تبدیل کنیم، خروجی‌ها را ذخیره یا پالایش کنیم و فرآیندهای خودکار بسازیم. ترکیب دقیق عملگرهایی مانند `>`، `>>`، `<`، `|`، فیلترها و `tee` آزادی عمل چشمگیری به ما می‌دهد تا هر نوع پردازش متنی را انجام دهیم و خروجی‌ها را همان‌طور که می‌خواهیم نگه داریم یا به اشتراک بگذاریم.
